...
<body>
    ...
    <div class="container-fluid mt-4">
        ...
        <!-- Alert (kalo ada notif success/error) -->
        ...
        <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Form kecil buat nambah ke keranjang (manggil CartController@add) -->
            ...
            <div class="col-md-5">
                        ...
                        @forelse ($cart as $id => $item)
                            <li class="list-group-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <!-- Form kecil buat update quantity (manggil CartController@update) -->
                                    ...
                                    <!-- Form kecil buat hapus item (manggil CartController@remove) -->
                ...
                <!-- Form ini manggil OrderController@store -->
