...
<section class="kategori">
                ...
                <div class="kategori-buttons">
                    ...
                    <a href="{{ route('orders.index', ['category' => 'makanan', 'search' => request('search')]) }}">
                        <button type="button" class="{{ request('category') == 'makanan' ? 'active' : '' }}">makanan</button>
                    </a>
                    <a href="{{ route('orders.index', ['category' => 'minuman', 'search' => request('search')]) }}">
                        <button type="button" class="{{ request('category') == 'minuman' ? 'active' : '' }}">minuman</button>
                    </a>
                </div>
            </section>
