...
@section('title', 'Edit Meja - MeTime')
...
@section('content')
            <div class="form-container">
                <h2>Edit Meja</h2>
                <form class="menu-form" action="{{ route('tables.update', $table->id) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="form-group">
                        <label>Nomor Meja</label>
                        <input type="text" name="table_number" placeholder="Contoh: 01, 02, atau VIP 1"
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('tables.index') }}" class="btn cancel">Batal</a>
                    </div>
                </form>
            </div>
        @endsection
